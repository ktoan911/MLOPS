#!/bin/bash
# #! là ký hiệu shebang. nếu dòng đó là #!/bin/bash, nó sẽ biết phải dùng Bash để chạy phần còn lại của script. Nếu bạn không thêm dòng này, thì hệ thống sẽ dùng shell mặc định (thường là /bin/sh, có thể không hỗ trợ một số cú pháp riêng của Bash).



#run this script with the command:
# bash basic_script.sh 10
...
# Don't use [[ 10 > 9 ]] dùng cho so sánh chuỗi, but use 
